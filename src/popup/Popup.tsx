        ...
        <CardContent className="space-y-4">
          <Tabs defaultValue="home" className="w-full">
            ...
            <TabsContent value="home" className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch id="home-feed" checked={homePageHidden} onCheckedChange={setHomePageHidden} />
              </div>
              <div className="flex items-center justify-between">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="advanced">
              ...
              <AccordionContent>
                <p className="text-sm text-muted-foreground">Advanced customization options will appear here.</p>
              </AccordionContent>
            </AccordionItem>
          </Accordion>

          <div className="flex gap-2">
            <Button variant="default" className="flex-1">Save Settings</Button>
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Fockey transforms YouTube into a minimalist, distraction-free experience. Hide thumbnails, recommendations, and UI elements to stay focused on what matters.
                  </DialogDescription>
                </DialogHeader>
              </DialogContent>
            </Dialog>
